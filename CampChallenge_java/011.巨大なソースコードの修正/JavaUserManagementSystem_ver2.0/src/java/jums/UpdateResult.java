...
public class UpdateResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            //<<update.jspにて変更した内容を更新するように処理しました>>
            ...
            UserDataDTO udd = (UserDataDTO)hs.getAttribute("resultDetail");
            ...
            //<更新する際UserIDを指定するのでセッション"resultDetail"を呼び出す>
            dto.setUserID(udd.getUserID());
            
            //<情報を更新するDAOを呼び出して処理>
            UserDataDAO .getInstance().update(dto);
            
            //<更新に成功したのでセッション"resultDetail"は削除>
